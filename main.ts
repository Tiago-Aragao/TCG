...
const criatura4J1 = new Criatura("Mago Goblin", 4, 1, 'magico');
const criatura5J1 = new Criatura("Goblin de Badogue", 1,1,'distancia');
const criatura6J1 = new Criatura("Lanceiro Indestrutivel", 10,10);
...
const jogador1 = new Jogador("Jogador 1", [criatura1J1, criatura2J1, criatura3J1, criatura4J1, criatura5J1, criatura6J1]);
...
jogador1.tabuleiro.conjurarCriatura(jogador1.deck[3], "fundo", 0);
jogador1.tabuleiro.conjurarCriatura(jogador1.deck[4], "fundo", 1);
jogador1.tabuleiro.conjurarCriatura(jogador1.deck[5], "fundo", 2);
